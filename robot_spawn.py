...
def move(cartesian_destination, upper_limits, lower_limits, sawyerId, joints):
    ...
    target_joint_state = np.array(p.calculateInverseKinematics(
        sawyerId, 18, cartesian_destination, lowerLimits=lower_limits, upperLimits=upper_limits))
    ...
    p.setJointMotorControlArray(sawyerId, joints, p.POSITION_CONTROL, target_joint_state, velocities, [
